...
string username = Environment.GetEnvironmentVariable("SA_USERNAME") ?? "";
...
connectionString = connectionString.Replace("${SA_USERNAME}", username)
...
builder.Services.AddTransient<CourseStudentDataService>();
builder.Services.AddTransient<CourseStudentBusinessService>();

builder.Services.AddTransient<InfoLimpiezaDataService>();
builder.Services.AddTransient<InfoLimpiezaBusinessService>();

builder.Services.AddTransient<CourseAssignmentDataService>();
builder.Services.AddTransient<CourseAssignmentBusinessService>();

builder.Services.AddTransient<ScheduleDataService>();
builder.Services.AddTransient<ScheduleBusinessService>();
